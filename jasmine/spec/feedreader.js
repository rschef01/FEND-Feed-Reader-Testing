    ...
    */
    ...
    describe('Initial Entries', function() {
         ...
         */
         ...
         //write expect statement expecting the feed container’s children property to have a length property greater than 0 to be true
    ...
    describe('New Feed Selection', function() {
        ...
        it('content changes', function() {
            ...
            Array.from(feed.children).forEach(function(entry,index) {
                //expect statement expecting two different entries being compared from the first and second feed
